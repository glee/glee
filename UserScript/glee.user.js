...
jQuery(document).ready(function(){
	...
	var gleeCSS = '#gleeBox{ line-height:20px;z-index:999999;position:fixed; left:5%; top:35%; display:none; overflow:auto;width:90%; background-color:#333; opacity:0.65; color:#fff; margin:0;font-family:Calibri,Helvetica,serif; padding:0;text-align:left;}#gleeSearchField{ outline:none;width:90%; color:#fff; background-color:#333; margin:0; padding:5px;border:none; font-size:100px; font-family:Calibri,Helvetica,serif; }#gleeSubText, #gleeSubURL, #gleeSubActivity{font-size:15px;font-family:Calibri,Helvetica,serif;color:#fff; font-weight: normal;width:auto}#gleeSubText{ padding:5px;float:left;}#gleeSubURL{ padding:5px; display:inline; float:right;}#gleeSubActivity{padding:5px;color:#ccc;height:10px;display:inline;float:left;}';
