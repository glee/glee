function gleebox_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
gleebox_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				gleebox_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
gleebox_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
gleebox_xmlhttpRequester.prototype.setupRequestEvent =
